...
cd ${GOPATH}/src/github.com/ruanxingbaozi/k8s-billing
go build -o deploy/build/billing cmd/main.go || exit 0

cd ${GOPATH}/src/github.com/ruanxingbaozi/k8s-billing/deploy/build
sudo docker build -t k8s-billing:v1.0.1 .

cd ${GOPATH}/src/github.com/ruanxingbaozi/k8s-billing/deploy/deployment
